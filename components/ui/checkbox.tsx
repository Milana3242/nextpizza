...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ...
    {...props}>
    <CheckboxPrimitive.Indicator className={cn('flex items-center justify-center text-current  bg-orange-500')}>
      <Check className="h-4 w-4 bg-orange-500" strokeWidth={3} />
